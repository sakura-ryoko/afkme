...
package com.sakuraryoko.afkme.impl.modinit;
...
@ApiStatus.Internal
public class AfkMeInit implements IModInitDispatcher
{
    private static final AfkMeInit INSTANCE = new AfkMeInit();
    public static AfkMeInit getInstance() { return INSTANCE; }
    ...
    {
        AfkMe.debugLog("Initializing Mod.");
